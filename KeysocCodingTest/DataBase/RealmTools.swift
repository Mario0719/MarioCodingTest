...
extension RealmTools {
    ...
    static func configRealm(keyWord: String? = nil,
        ...
        let fileURL = docPath.appending("/defaultDB.realm")
    ...
    static func deleteRealmFiles() -> Bool {
        ...
        for URL in realmURLs {
            do {
                ...
                self.configRealm(keyWord: sharedInstance.currentKeyWord, schemaVersion: sharedInstance.currentSchemaVersion)
            } catch {
                // handle error
                return false
            }
